...
void UPartyGameState::SetPartyType(EPartyType InPartyType, bool bLeaderFriendsOnly, bool bLeaderInvitesOnly)
{
        ...
        UE_LOG(LogParty, Warning, TEXT("UPartyGameState::SetPartyType Not Implemented"));
}

void UPartyGameState::SetInvitesDisabled(bool bInvitesDisabled)
{

        UE_LOG(LogParty, Verbose, TEXT("UPartyGameState::SetInvitesDisabled Non party leader trying to set invites disabled!"));
...
UPartyMemberState* UPartyGameState::InitPartyMemberStateFromLocalPlayer(const ULocalPlayer* LocalPlayer)
{
    ...
    /*TSharedPtr<const FUniqueNetId>*/FUniqueNetIdRepl UniqueNetId = LocalPlayer->GetPreferredUniqueNetId();
