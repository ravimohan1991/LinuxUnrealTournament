...
struct FPartyDetails : public TSharedFromThis<FPartyDetails>
{
	...
	{
        return PartyJoinInfo->GetLeaderId(); Lets just comment it.
    }*/
...
public:
    ...
    /** @return the String equivalent of the EMemberChangedReason enum. */
    FString ToString(EMemberChangedReason InReason);

    /** @return the String equivalent of the EMemberExitedReason enum. */
    FString ToString(EMemberExitedReason InReason);
